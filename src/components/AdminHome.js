...
import {CardImg, Col , Row, Card, Container, Nav, NavLink, Navbar, NavbarBrand,   Button } from "react-bootstrap";
...
function AdminHome(){
  ...
  // Navigate to all bookings table 
  const handleAdminDetailPage = () => {
    navigate('/adminpage')
} 
  ...
  navigate('/services')
    ...
    return(
        <div>
             <div>
            <div className="main">
            <Navbar bg="transparent" data-bs-theme="dark" className="shadow p-3 mb-3 bg-body">
        <Container>
          <NavbarBrand href="/">Service center</NavbarBrand>
          <Nav style={{border:'solid 1px white',borderRadius:'60px'}}>
             <NavLink style={{padding:'10px'}} onClick={handleAdminDetailPage}>View Bookings</NavLink>
          </Nav>
        </Container>
      </Navbar>
            <br/>
           ...
           <h3 data-aos="fade-up" data-aos-duration="1000">Services</h3>
            ...
            <Col>
            <div className="form">
            <h4 data-aos="fade-left" data-aos-duration="1500">Add New Service</h4>
        
            <p data-aos="fade-left" data-aos-duration="1500">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
            <div className="add-btn">
            <Button data-aos="fade-left" data-aos-duration="1500" className="service-btn" onClick={handleNewService}>Add</Button>
            </div>
